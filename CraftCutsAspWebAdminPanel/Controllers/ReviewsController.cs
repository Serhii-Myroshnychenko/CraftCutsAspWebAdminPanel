...
namespace CraftCutsAspWebAdminPanel.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ReviewsController(CraftCutsNewDB2Context context)
        {
            _context = context;
        }
        ...
        {
            var craftCutsNewDB2Context = _context.Reviews.Include(r => r.Customer);
        ...
        public async Task<IActionResult> Create([Bind("ReviewId,CustomerId,Feedback,Stars")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewId,CustomerId,Feedback,Stars")] Review review)
        {
